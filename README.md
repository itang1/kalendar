...
**A calendar of the church year, read through a Reformed lens.** Kalendar lays the year out as a ring of seasons, from Advent through Easter and the long green stretch of Ordinary Time, so you can see the shape of the year instead of just counting days forward.
...
The historic liturgical calendar is Catholic in origin. Kalendar filters it through a **Reformed** view of worship, where Scripture is the final authority, keeping only what the Reformed tradition actually observes:
...
- **Removed:** non-biblical saints' days and devotions without footing in Scripture, such as Corpus Christi, the Sacred Heart, Divine Mercy, All Souls, and the Marian feasts.
- **Added:** **Reformation Day** (Oct 31) and a layer of everyday **U.S. holidays**.

Names and descriptions use a plain, describing voice, saying "Catholic churches use violet" rather than "the priest wears violet," so nothing in the app needs a specialist to explain.
